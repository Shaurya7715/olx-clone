...
//     try {
//       await signInWithPopup(auth, googleProvider);
//       setLoginPop(false); // Close modal on success
//     } catch (err) {
...
//   return (
//     <div className="fixed inset-0 flex items-center justify-center bg-zinc-950 bg-opacity-75 z-10">
//       <div className="relative bg-white rounded-lg shadow-xl p-6 sm:w-96">
//         <h1
//           onClick={() => setLoginPop(false)}
//           className="cursor-pointer font-semibold text-2xl absolute top-3 right-4"
//         >
//           ✕
//         </h1>
//         <div className="text-center">
//           <img src={guitar} alt="Guitar" className="w-20 h-20 mx-auto" />
//           <p className="text-base font-medium mt-5">
//             Help us to become one of the safest places to buy and sell
//           </p>
//           <div className="flex items-center border-2 border-black p-2 rounded-md mt-6 cursor-pointer">
...
//           </div>
//           <h1 className="mt-4 cursor-pointer">OR</h1>
//           <h1 className="mt-4 underline cursor-pointer">Login with Email</h1>
//           <p className="text-xs mt-16">All your personal details are safe with us.</p>
//           <p className="text-xs mt-2">
//             If you continue, you accept
//             <span className="text-blue-600"> OLX Terms and Conditions & Privacy Policy</span>
//           </p>
//         </div>
//       </div>
//     </div>
